abstract class PlaylistRepository {
  ...
  Future<Map<String, String>> fetchClickPlaylist(Map<String, String> playlist);
...
class DemoPlaylist extends PlaylistRepository {
  ...
  //make a function to handle input data from api
  @override
  Future<Map<String, String>> fetchClickPlaylist(
      Map<String, String> playlist) async {
    return playlist;
  }
